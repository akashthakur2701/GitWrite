  ...
  const testimonials = [
    {
      name: "Sarah Johnson",
      role: "Tech Writer",
      content: "GitWrite has revolutionized how I share my technical knowledge. The writing experience is seamless!",
      avatar: "https://images.unsplash.com/photo-1494790108755-2616b612c113?w=150"
    },
    {
      name: "Alex Chen",
      role: "Software Engineer", 
      content: "Finally, a platform that understands developers. The markdown support and code highlighting are perfect.",
      avatar: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=150"
    },
    {
      name: "Maria Garcia",
      role: "Designer",
      content: "The clean interface lets me focus on writing. Plus, the community engagement features are amazing!",
      ...
      <div className="relative overflow-hidden">
            ...
            <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
              <div className="sm:text-center lg:text-left">
                <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
                  <span className="block xl:inline">Write, Share,</span>{' '}
                  <span className="block text-blue-600 xl:inline">Inspire</span>
                </h1>
                <p className="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
                  GitWrite is the modern blogging platform for developers, writers, and creators. 
                  Share your ideas with beautiful formatting, engage with a vibrant community, 
        ...
        <div className="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
          <img
            ...
            alt="People writing and collaborating"
          />
        </div>
      </div>
          ...
          <div className="mt-10">
            <div className="space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10">
              <div className="relative">
                ...
                <p className="ml-16 text-lg leading-6 font-medium text-gray-900">Rich Text Editor</p>
                <p className="mt-2 ml-16 text-base text-gray-500">
                  Write with a powerful editor that supports markdown, code highlighting, and beautiful formatting.
                </p>
              </div>
              ...
              <div className="relative">
                ...
                <p className="mt-2 ml-16 text-base text-gray-500">
                  Connect with readers through likes, comments, and follows. Build your audience organically.
                </p>
              </div>
              ...
              <div className="relative">
                ...
                <p className="mt-2 ml-16 text-base text-gray-500">
                  Track your blog performance with detailed analytics on views, engagement, and reader demographics.
                </p>
              </div>
              ...
              <div className="relative">
                ...
                <p className="ml-16 text-lg leading-6 font-medium text-gray-900">Tags & Categories</p>
                <p className="mt-2 ml-16 text-base text-gray-500">
      ...
      <div className="bg-blue-600">
        <div className="max-w-2xl mx-auto text-center py-16 px-4 sm:py-20 sm:px-6 lg:px-8">
          ...
          <p className="mt-4 text-lg leading-6 text-blue-200">
            Join thousands of writers sharing their stories on GitWrite. Start your journey today.
          </p>
          <Link
            to="/signup"
        ...
        <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 md:flex md:items-center md:justify-between lg:px-8">
          ...
          <div className="mt-8 md:mt-0 md:order-1">
            <p className="text-center text-base text-gray-400">
              &copy; 2024 GitWrite. Made with ❤️ for writers.
            </p>
          </div>
        </div>
      </footer>
