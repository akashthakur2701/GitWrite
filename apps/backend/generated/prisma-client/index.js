...
const config = {
  "generator": {
    ...
    "output": {
      "value": "/Users/akash/Desktop/Desktop - AKASH’s MacBook Pro/GitWrite/apps/backend/apps/backend/generated/prisma-client",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
    ...
    "previewFeatures": [],
    "sourceFilePath": "/Users/akash/Desktop/Desktop - AKASH’s MacBook Pro/GitWrite/apps/backend/prisma/schema.prisma",
    "isCustomOutput": true
  },
  "relativeEnvPaths": {
    "rootEnvPath": null
  ...
  "inlineSchema": "generator client {\n  provider = \"prisma-client-js\"\n  output   = \"../apps/backend/generated/prisma-client\"\n}\n\ndatasource db {\n  provider = \"postgresql\"\n  url      = env(\"DATABASE_URL\")\n}\n\nmodel User {\n  id       String  @id @default(uuid())\n  email    String  @unique\n  name     String?\n  password String\n  posts    Post[]\n}\n\nmodel Post {\n  id        String   @id @default(uuid())\n  title     String\n  content   String\n  published Boolean  @default(false)\n  author    User     @relation(fields: [authorId], references: [id])\n  authorId  String\n  createdAt DateTime @default(now())\n}\n",
  "inlineSchemaHash": "3f4fe8710874b97352f3f9a40855809b5d1000e5d2046e9262e006e243551374",
  "copyEngine": true
}
